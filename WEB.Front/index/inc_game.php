		 ...
		 var flag=false;
			...
			slider.on('update',function(value){
				...
				<!--div class="danwei">
					...
					<label>元<input type="radio" value="4.000" data-max-fan-dian="<?=$this->settings['betModeMaxFanDian0']?>" name="danwei" <?=$this->iff($mode=='2.000','checked')?> /></label><?}?>
					<?php if($this->settings['jiaomosi']==1){?>
					<label>角<input type="radio" value="0.500" data-max-fan-dian="<?=$this->settings['betModeMaxFanDian1']?>" name="danwei" <?=$this->iff($mode=='0.200','checked')?> /></label><?}?>
					...
					<label>厘<input type="radio" value="0.007" data-max-fan-dian="<?=$this->settings['betModeMaxFanDian3']?>" name="danwei" <?=$this->iff($mode=='0.002','checked')?> /></label><?}?>
				</div-->
				...
				<input type="button" class="addBtn" onclick="gameActionAddCode1()" value="一键投注">
