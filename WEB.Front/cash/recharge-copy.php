...
<table width="100%" border="0" cellspacing="1" cellpadding="4" class='table_b'>
	...
	<div class="form_switch_main">
	  <form action="/mypay/pay.php" method="POST" name="a32" target="_blank" id="frm1">
			...
			<input type="radio" name="rbPayMType" id="utype24" value="10022" title="正在充值">
			<label class="bk_r" for="utype24">正在充值</label>
			
			</div>
	</div>
			<div class="form_submit_box">
	<input class="button" id="addmenber"   type="submit" value="进入支付">
...
<table width="100%" border="0" cellspacing="1" cellpadding="4" class='table_b'>
	...
	<form action="/mypay/pay.php" method="post" name="a" target="_blank" > 
