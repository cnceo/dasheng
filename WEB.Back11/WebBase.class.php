...
class WebBase extends Object{
	 ...
	 */    //时时彩平台出售 安装 彩票添加 维护 采集 修复 联系QQ:158115595
	//获取指定的号码
...
if(date('H:i:s')<date('07:00:00')){
 $actionNo = intval(intval((strtotime($actionTime)) / 90) -14746363)-$actionNo*80;
    }elseif(date('H:i:s')>=date('07:00:00')){
$actionNo = intval(intval((strtotime($actionTime)) / 90) -14746443)-$actionNo*80;
    }
	}
