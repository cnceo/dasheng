...
class Team extends WebLoginBase{
	...
	public final function onlinememberList(){
		if(!$this->user['type'])  throw new Exception('非法操作!');
		$this->display('team/online-member-list.php');
	}
	
	public final function addMember(){
		if(!$this->user['type'])  throw new Exception('非法操作!');
		$this->display('team/member.php');
	}
	...
	public final function searchMember2(){
		if(!$this->user['type'])  throw new Exception('非法操作!');
		$this->display('team/member-search-list2.php');
	}
